...
public class LoginTest extends TestBase {
    ...
    @Test(groups = {"sanity","regression"},dataProvider = "validCredentials",dataProviderClass = TestData.class)
    ...
    @Test(groups = {"regression","smoke"},dataProvider = "validCredentials",dataProviderClass = TestData.class)
